...
<table class="page">
  <tr class="menu">
    ...
    <td class="active"><a href="/page4">page 4</a></td>
  </tr>
  <tr>
    ...
    <td colspan="2" class="content" valign="top">
        <div>
          <p>The US president told Reuters he would like to solve the crisis diplomatically but that it was "difficult" and a "major, major conflict" was possible. He also said it had been "very hard" for Kim Jong-un to take over North Korea at such a young age.The UN Security Council is meeting to discuss North Korea on Friday.US Secretary of State Rex Tillerson has said China has told the US it will impose sanctions on North Korea if it conducts further nuclear tests.</p>
          ...
          <img src="http://javapointers.com/wp-content/themes/javapointers2016/img/leaderboard.jpg" />
          <p>Vestibulum hendrerit elementum efficitur. Nunc non gravida turpis, eu mollis diam. Phasellus tincidunt sed dolor ac sollicitudin. Quisque mollis fringilla est, ut rhoncus leo vulputate in. In commodo accumsan mi, id fermentum arcu eleifend ac. Suspendisse porttitor non eros suscipit rhoncus. Pellentesque eget condimentum tortor, vel efficitur dolor. Ut neque neque, feugiat et nisi ut, feugiat tempor sem. Nulla malesuada sed arcu sit amet egestas. Aenean iaculis, est sit amet dignissim accumsan, lacus sapien placerat lorem, vel commodo lorem turpis et nulla. Suspendisse sed sollicitudin turpis, eu imperdiet erat.  </p>
        </div>
      </td>
    <td class="sidebar" valign="top">
...
<script>alert('script call example');</script>
</body>
</html>